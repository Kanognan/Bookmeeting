...
<body>
  ...
  <div class="container">
    <div class="card card-edit">
      <h3 class="card-header">แก้ไขห้องประชุม</h3>
      <div class="card-body card-body-form">
        <form action="editroom_model.php" method="post" enctype="multipart/form-data">
          <?php $sql = "SELECT * FROM room where room_id  = '$id' ";
          ...
          while ($row = mysqli_fetch_array($query)) {
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control" id="seat_qty" name="seat_qty"
                  value="<?php echo $row['seat_qty']; ?>" required>
              </div>
            </div>
            <!-- ---------------->
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control" id="gadget" name="gadget" value="<?php echo $row['gadget']; ?>"
                  required>
              </div>
            </div>
            <!-- ---------------->
            <div class="mb-3 row">
              <label for="room_img" class="col-md-2 col-form-label">เปลี่ยนรูปห้องประชุม : </label>
              <div class="col-md-10 card card-img"
                style="display: block; margin-left: auto; margin-right: auto; width: 50%;">
                <img src="../room_img/<?php echo $row['room_img']; ?>" class="card-img-top" alt="room" style="width:100%">
                <div class="card-body cradimg">
                  <p class="card-text text-center">รูปเดิม</p>
                  <p class="card-text text-center text-muted">* ไม่ต้องทำการอัพโหลดรูปใหม่ หากต้องการใช้รูปเดิม</p>
                  <hr>
                  <label for="">เลือกรูปเพื่อเปลี่ยน</label>
                  <input type="file" class="form-control" id="room_img" name="room_img"
                    value="<?php echo $row['room_img']; ?>">
                </div>
              </div>
            </div>
            ...
            <div class="button d-flex justify-content-center">
              <button type="reset" class="btn btn-cancel" onclick="document.location='admin_index.php'"> ยกเลิก </button>
              <button type="submit" class="btn btn-more"> บันทึก </button>
