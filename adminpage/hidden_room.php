  ...
  <div>
    <div class="container recom">
      <div class="mt-5 d-flex justify-content-center text-center row d-grid gap-4">
        ...
        $hide = "yes";
        $counthidden = 0;
        $query = mysqli_query($conn, "select * from room WHERE hide_status = '$hide' ");
          ...
          if (empty($check_del)) {
            ...
            <div class="card col-6 col-md-4 col-lg-4 col-xl-4 p-2 bg-light border roomimg">
              ...
              <div class="card-body">
                ...
                <a href="delete_room.php?id=<?php echo $row['room_id']; ?>" onclick="return confirm('ต้องการลบห้องหรือไม่')"
                  class="btn btn-more" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ลบห้อง"><i
                    class="bi bi-trash-fill"></i></a>

                <a href="unhideroom_model.php?id=<?php echo $row['room_id']; ?>" class="btn btn-more"
                  data-bs-toggle="tooltip" data-bs-placement="bottom" title="ยกเลิกการซ่อน"><i
