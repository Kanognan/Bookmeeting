        ...
        <div class="container hnav">
            ...
            <div class="collapse navbar-collapse align-self-center navdrop" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto ">
                    <li class="nav-item">
                        <a class="nav-link mx-2" aria-current="page" href="user_index.php">หน้าหลัก</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mx-2" href="calendar.php">ตารางการจองห้อง</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropa" style="text-align: center;" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="booking.php">จองห้องประชุม</a></li>
                            <li><a class="dropdown-item" href="booking_history.php">ประวัติการจองห้อง</a></li>
                            <li><a class="dropdown-item" href="#">วิธีการจองห้อง</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mx-2" href="complaint.php">แจ้งปัญหา</a>
                    </li>
                    <li class="nav-item dropdown">
