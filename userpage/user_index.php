...
<body>
    ...
    <div class="second" id="second">
        ...
        <div class="hero-banner">
            ...
            <!-- <h1 class="hero-banner__title hero-banner__stroked-title">Wonderful title</h1> -->
        </div>
                    ...
                    if (empty($check_del)) {
                        ...
                        <div class="card col-6 col-md-4 col-lg-4 col-xl-4 p-2 bg-light border roomimg pic">
                            ...
                            <div class="card-body">
                                ...
                                <a href="room_detail.php?id=<?php echo $row['room_id']; ?>" class="btn btn-more">รายละเอียด</a>
                            </div>
                        </div>
                        <?php
                    }
